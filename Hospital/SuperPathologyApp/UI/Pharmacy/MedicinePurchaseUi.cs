...
{
    public partial class MedicinePurchaseUi : Form
    {
        public MedicinePurchaseUi()
        {
            InitializeComponent();
        ...
        private void ClearText()
        {
            ...
            billNoTextBox.Text = _gt.GetInvoiceNo(3);
            ...
            totalComisionTextBox.Text = "0";
            totalVatTextBox.Text = "0";
        ...
        private void GridWidth(DataGridView dataGrid)
        {
            ...
            dataGrid.Columns[2].Width = QtyTextBox.Width - 1;
            dataGrid.Columns[3].Width = unitPriceTextBox.Width-1;
            dataGrid.Columns[4].Width = bonusQtyTextBox.Width-2;
            dataGrid.Columns[5].Width = unitTotalPriceTextBox.Width-1;
            
            dataGrid.Columns[6].Visible= false;
            dataGrid.Columns[7].Width = vatTextBox.Width-1;
            dataGrid.Columns[8].Visible = false;
            dataGrid.Columns[9].Width = commisionTextBox.Width-2;
            
            dataGrid.Columns[10].Width = tpTextBox.Width-2;
            dataGrid.Columns[11].Width = expireDateTimePicker.Width-2;
        ...
        private void AddDataToGrid()
        {
            ...
            {
                //double vatAmt = Convert.ToDouble(unitTotalPriceTextBox.Text) * 0.01 * Convert.ToDouble(Hlp.IsNumeric(vatTextBox.Text) ? vatTextBox.Text : "0");
                double vatAmt = Convert.ToDouble(Hlp.IsNumeric(vatTextBox.Text) ? vatTextBox.Text : "0");

                
                double comAmt = Convert.ToDouble(unitTotalPriceTextBox.Text) * 0.01 * Convert.ToDouble(Hlp.IsNumeric(commisionTextBox.Text) ? commisionTextBox.Text : "0");
                dataGridView1.Rows.Add(itemIdTextBox.Text, itemNameTextBox.Text, QtyTextBox.Text, unitPriceTextBox.Text, bonusQtyTextBox.Text, unitTotalPriceTextBox.Text,vatTextBox.Text,vatAmt,commisionTextBox.Text,comAmt,tpTextBox.Text,expireDateTimePicker.Value.ToString("yyyy-MM-dd"));
                itemIdTextBox.Text = "";
        ...
        private void ClearGridText()
        {
            ...
            bonusQtyTextBox.Text = "";
            unitTotalPriceTextBox.Text = "";
            vatTextBox.Text = "";
            commisionTextBox.Text = "";
            itemNameTextBox.Focus();

            totalItemTextBox.Text = dataGridView1.Rows.Count.ToString();

            double totAmt = 0, vatTotal = 0, comTotal = 0;
            for (int i = 0; i < dataGridView1.Rows.Count; i++)
            {
                totAmt += Convert.ToDouble(dataGridView1.Rows[i].Cells[5].Value);
                vatTotal += Convert.ToDouble(dataGridView1.Rows[i].Cells[7].Value);
                comTotal += Convert.ToDouble(dataGridView1.Rows[i].Cells[9].Value);
            }
            totalAmountTextBox.Text = Math.Round(totAmt, 2).ToString();
            totalVatTextBox.Text = Math.Round(vatTotal, 2).ToString();
            totalComisionTextBox.Text = Math.Round(comTotal, 2).ToString();
            netPayableTextBox.Text =Math.Round(totAmt + vatTotal - comTotal,2).ToString();
        }
        ...
        private void saveAndPrintButton_Click_1(object sender, EventArgs e)
        {
            if (CheckSuccess())
            {
                var aMdl = new PurchaseModel
                {
                    ...
                    //TotalVat = Convert.ToDouble(Hlp.StringToDouble(totalVatTextBox.Text)),
                    TotalVat = Convert.ToDouble(Hlp.StringToDouble(vatTextBox.Text)),
                   
                    TotalComision= Convert.ToDouble(Hlp.StringToDouble(totalComisionTextBox.Text)),
        ...
        private void GetInvoiceDataForEdit(string invNo)
        {
            try
            {
                ...
                totalVatTextBox.Text =aMdl.TotalVat.ToString();
                totalComisionTextBox.Text = aMdl.TotalComision.ToString();
        ...
        private void MedicinePurchaseUi_Load(object sender, EventArgs e)
        {
            ...
            expireDateTimePicker.Value.AddYears(2);
        ...
        {
            helpDg.DataSource = null;
            helpDg.DataSource = Hlp.LoadDbByQuery(0, "SELECT Id,Name,Address FROM tb_ph_SUPPLIER", suppNameTextBox.Text, "(convert(varchar,Id)+Name) ");
            Hlp.GridFirstRowDeselect(helpDg);
        ...
        private void LoadDataGridByItem()
        {
            ...
            string cond = "";
            if (suppNameTextBox.Text.ToUpper().Contains("LOCAL MARKET")==false)
            {
                cond += " AND a.SuppId='"+ suppIdTextBox.Text +"'";
            }

            helpDg.DataSource = null;
            helpDg.DataSource = Hlp.LoadDbByQuery(0, "SELECT a.Id,a.Name,c.Name AS GroupName, a.GenericName,b.Name AS SuppName FROM tb_ph_ITEM a INNER JOIN tb_ph_SUPPLIER b ON a.SuppId=b.Id INNER JOIN tb_ph_ITEM_GROUP  c ON a.GroupId=c.Id  WHERE 1=1 AND (a.Name+a.GenericName+b.Name) LIKE '%"+ itemNameTextBox.Text +"%' "+ cond +"");
            Hlp.GridFirstRowDeselect(helpDg);
            ...
            if (e.KeyCode==Keys.Enter)
            {
                if (itemNameTextBox.Text.Length > 0)
                {
                    if (helpDg.Rows.Count > 0)
                    {
                        ...
                        unitPriceTextBox.Text = _gt.FncReturnFielValueLab("tb_ph_ITEM", "Id='" + itemIdTextBox.Text + "'", "LastPPrice");
        ...
        private void expireDateTimePicker_KeyDown(object sender, KeyEventArgs e)
        {
            if (e.KeyCode==Keys.Enter)
            {
                if (_gt.FnSeekRecordNewLab("tb_ph_ITEM", "Id='" + itemIdTextBox.Text + "'"))
                {
                    AddDataToGrid();
                    return;
                }
        ...
        private void unitPriceTextBox_KeyDown(object sender, System.Windows.Forms.KeyEventArgs e)
        {
            if (e.KeyCode == Keys.Enter)
            {
                 bonusQtyTextBox.Focus(); 
            }
        }

        private void bonusQtyTextBox_KeyDown(object sender, System.Windows.Forms.KeyEventArgs e)
        {
            if (e.KeyCode == Keys.Enter)
            {
        ...
        private void vatTextBox_KeyDown(object sender, System.Windows.Forms.KeyEventArgs e)
        {
            if (e.KeyCode == Keys.Enter)
            {
                UpdateTp();
                commisionTextBox.Focus(); 
            }
        }
        ...
        private void UpdateTp()
        {
            ...
            double commAmt = Convert.ToDouble(unitTotalPriceTextBox.Text) * 0.01 * Convert.ToDouble(Hlp.IsNumeric(commisionTextBox.Text) ? commisionTextBox.Text : "0");

            double unitTotal = Convert.ToDouble(unitTotalPriceTextBox.Text) + vatAmt-commAmt;
            double totQty = Convert.ToDouble(Hlp.IsNumeric(QtyTextBox.Text) ? QtyTextBox.Text : "0") +
                            Convert.ToDouble(Hlp.IsNumeric(bonusQtyTextBox.Text) ? bonusQtyTextBox.Text : "0");
            
            double costPrice = Math.Round(unitTotal / totQty, 2);
            tpTextBox.Text = costPrice.ToString();

        }

        private void commisionTextBox_KeyDown(object sender, System.Windows.Forms.KeyEventArgs e)
        {
            if (e.KeyCode == Keys.Enter)
            {
        ...
        private void bonusQtyTextBox_Enter(object sender, EventArgs e)
        {
            bonusQtyTextBox.BackColor = Hlp.EnterFocus();
        }

        private void bonusQtyTextBox_Leave(object sender, EventArgs e)
        {
            bonusQtyTextBox.BackColor = Hlp.LeaveFocus();
        }

        private void vatTextBox_Enter(object sender, EventArgs e)
        {
            vatTextBox.BackColor = Hlp.EnterFocus();
        }

        private void vatTextBox_Leave(object sender, EventArgs e)
        {
            vatTextBox.BackColor = Hlp.LeaveFocus();
        }

        private void commisionTextBox_Enter(object sender, EventArgs e)
        {
            commisionTextBox.BackColor = Hlp.EnterFocus();
        }

        private void commisionTextBox_Leave(object sender, EventArgs e)
        {
            commisionTextBox.BackColor = Hlp.LeaveFocus();
        }
        ...
        private void unitTotalPriceTextBox_KeyDown(object sender, System.Windows.Forms.KeyEventArgs e)
        {
            if (e.KeyCode==Keys.Enter)
            {
                double qty = Convert.ToDouble(Hlp.IsNumeric(bonusQtyTextBox.Text)?bonusQtyTextBox.Text:"0") + Convert.ToDouble(QtyTextBox.Text);
                unitPriceTextBox.Text =Math.Round((Convert.ToDouble(Hlp.IsNumeric(unitTotalPriceTextBox.Text)?unitTotalPriceTextBox.Text:"0") / qty),2).ToString();
                tpTextBox.Text = unitPriceTextBox.Text;
                vatTextBox.Focus();
            }
        }
