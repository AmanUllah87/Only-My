...
{
    public partial class PharmacyReportViewer : Form
    {
        public PharmacyReportViewer(string reportFileName, string query, string dateRange, string dataSetName, string title)
        {
        ...
        private void PharmacyReportViewer_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                path = path + @"\Report\File\Pharmacy\";
        ...
        private void PharmacyReportViewer_FormClosed(object sender, FormClosedEventArgs e)
        {
            _rprt.Dispose();
            crystalReportViewer1.Dispose();
        }

        private void PharmacyReportViewer_FormClosing(object sender, FormClosingEventArgs e)
        {
            _rprt.Dispose();
            crystalReportViewer1.Dispose();
        }
