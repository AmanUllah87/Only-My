...
{
    public partial class IndoorReportViewer : Form
    {
        public IndoorReportViewer(string reportFileName, string query, string dateRange, string dataSetName, string title)
        {
        ...
        private void IndoorReportViewer_Load(object sender, EventArgs e)
        {
            try
            {
        ...
        private void IndoorReportViewer_FormClosing(object sender, FormClosingEventArgs e)
        {
            _rprt.Dispose();
            crystalReportViewer1.Dispose();
        }

        private void IndoorReportViewer_FormClosed(object sender, FormClosedEventArgs e)
        {
            _rprt.Dispose();
            crystalReportViewer1.Dispose();
        }
